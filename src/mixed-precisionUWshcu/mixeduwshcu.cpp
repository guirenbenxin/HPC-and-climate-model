...
void compute_uwshcu_inv_(int myid ,int size, int pcols_c ,int pver_c  ,int ncol_c  ,int pcnst_c   ,float ztodt_c  ,       
	...
	double *umf_inv  ,float *slflx_inv  ,float *qtflx_inv     ,                          
	float *flxprc1_inv,float *flxsnow1_inv,     				 
	double *qvten_inv,float *qlten_inv  ,float *qiten_inv     ,                         
	double *sten_inv ,float *uten_inv   ,float *vten_inv      ,float *trten_inv ,               
...
//ret2 = GPTLstart("Malloc");
	...
	double *qvten_c;
	hipHostMalloc((float**) &qvten_c,mix*mkx*sizeof(double));
	float *qlten_c;
...
int main(int argc, char *argv[])
{
	...
	double *umf_inv;
	float *slflx_inv,*qtflx_inv,*flxprc1_inv,*flxsnow1_inv;
	double *qvten_inv;
	float *qlten_inv,*qiten_inv;
	double *sten_inv;
